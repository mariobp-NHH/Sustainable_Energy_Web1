                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Table([
                                html.Tr([html.Td(['$E_1^s$']), html.Td(['$E_2^s$']), html.Td(['$CS^s$']), html.Td(['$\pi_1^s$']), html.Td(['$\pi_2^s$'])]),
                                html.Tr([html.Td(id='spot_E1'), html.Td(id='spot_E2'), html.Td(id='CSs_tab'), html.Td(id='pi1s_tab'), html.Td(id='pi2s_tab')]),
                            ]),
                        ], className="menu_box"),
                        ...
                        html.Div([
                            ...
                            html.Table([
                                html.Tr([html.Td(['$E_1^{sgo}$']), html.Td(['$E_2^{sgo}$']), html.Td(['$CS^{sgo}$']), html.Td(['$\pi_1^{sgo}$']), html.Td(['$\pi_2^{sgo}$'])]),
                                html.Tr([html.Td(id='spot_go_E1'), html.Td(id='spot_go_E2'), html.Td(id='CSsgo_tab'), html.Td(id='pi1sgo_tab'), html.Td(id='pi2sgo_tab')]),
                            ]),
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Table([
                                html.Tr([html.Td(['$E_1^{go1}$']), html.Td(['$E_2^{go1}$']), html.Td(['$CS^{go1}$']), html.Td(['$\pi_1^{go1}$']), html.Td(['$\pi_2^{go1}$'])]),
                                html.Tr([html.Td(id='go1_E1'), html.Td(id='go1_E2'), html.Td(id='CSgo1_tab'), html.Td(id='pi1go1_tab'), html.Td(id='pi2go1_tab')]),
                            ]),
                        ], className="menu_box"),
                        ...
                        html.Div([
                            ...
                            html.Table([
                                html.Tr([html.Td(['$E_1^{go2}$']), html.Td(['$E_2^{go2}$']), html.Td(['$CS^{go2}$']), html.Td(['$\pi_1^{go2}$']), html.Td(['$\pi_2^{go2}$'])]),
                                html.Tr([html.Td(id='go2_E1'), html.Td(id='go2_E2'), html.Td(id='CSgo2_tab'), html.Td(id='pi1go2_tab'), html.Td(id='pi2go2_tab')]),
                            ]),
...
def init_callbacks(dash_app):
    ...
    def update_graph(a_input, b_input, c_input, d_input, e_input, f_input, g_input, h_input):
        ...
        pi1go2, pi2go2 = profit(b1go, q2go11, q2go22)
        # Spot
        ...
        # GO2 Price
        E1go2_lst, E2go2_lst, a2_lst, CSgo2_lst = plot_exp_price(ah, al, ah_go, al_go, T, pmaxgo, pmaxs, N, alpha1, alpha2, cases, branch=2)
        # GO1 Price
        E1go1_lst, E2go1_lst, a2_lst, CSgo1_lst = plot_exp_price(ah, al, ah_go, al_go, T, pmaxgo, pmaxs, N, alpha1, alpha2, cases, branch=1)
        # Spot Price
        Esgo1_lst, Esgo2_lst, a2_lst, CSsgo_lst= plot_exp_price(ah, al, ah_go, al_go, T, pmaxgo, pmaxs, N, alpha1, alpha2, cases, branch=0)
        Es1_lst, Es2_lst, a2_lst, CSs_lst = plot_exp_price(ah, al, ah_go, al_go, T, pmaxgo, pmaxs, N, alpha1, alpha2, cases, branch=-1)
        ...
        return fig_area_spot, fig_go_areas, fig_spot_strategies, fig_spot_go_strategies, fig_go1, fig_go2, spot_E1, spot_E2, spot_go_E1, spot_go_E2, go1_E1, go1_E2, go2_E1, go2_E2, CSs_tab, CSsgo_tab, CSgo1_tab, CSgo2_tab, pi1s_tab, pi2s_tab, pi1sgo_tab, pi2sgo_tab, pi1go1_tab, pi2go1_tab, pi1go2_tab, pi2go2_tab