...
def chat_web_chat_home():
    ...
    chats = Chat.query.filter(Chat.chat_module=='Home Chat').order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
...
def chat_web_chat_app_g1():
    ...
    chats = Chat.query.filter(Chat.chat_module=='App Module Chat').\
        filter(Chat.chat_group=='Group 1').order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
...
def chat_web_chat_app_g2():
    page = request.args.get('page', 1, type=int)
    chats = Chat.query.filter(Chat.chat_module=='App Module Chat').\
        filter(Chat.chat_group=='Group 2').order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
...
def chat_web_chat_app_g3():
    page = request.args.get('page', 1, type=int)
    chats = Chat.query.filter(Chat.chat_module=='App Module Chat').\
        filter(Chat.chat_group=='Group 3').order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
...
def chat_web_chat_app_g4():
    page = request.args.get('page', 1, type=int)
    chats = Chat.query.filter(Chat.chat_module=='App Module Chat').\
        filter(Chat.chat_group=='Group 4').order_by(Chat.date_posted.desc()).paginate(page=page, per_page=2)
